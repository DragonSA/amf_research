...
\begin{table}[ht]
 ...
 \begin{tabular}{|l|l|l|}\hline
  \textbf{Choice}     & \textbf{Payoff} & \textbf{Condition} \\\hline
  Redemption          & \Kp             & $(\V < \Kp)\wedge(\t \in \Tv)\wedge[(\Kv\S \le \V)\lor(\t \not\in \Tv)]$ \\\hline
  Forced redemption   & \Kc             & $(\V > \Kc)\wedge(\t \in \Tc)\wedge[(\Kv\S \le \Kc)\lor(\t \not\in\Tv)]$ \\\hline
  Conversion          & $\Kv\S$         & $(\Kv\S > \V)\wedge(\t \in \Tv)$ \\\hline
  Forced conversion   & $\Kv\S$         & $(\V \ge \Kv\S > \Kc)\wedge(\t \in \Tv)\wedge(\t \in \Tc)$ \\\hline
  Terminal conversion & $\Kv\ST$        & $(\Kv\ST > \N)\wedge(\t = \T)$ \\\hline
  Maturity            & \R              & $(\Kv\ST \le \N)\wedge(\t = \T)$ \\\hline
 \end{tabular}
 \label{tab:choice}
\end{table}
