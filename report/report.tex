...
A second approach was to price the convertible bond based on the issuer's stock price \cite{MS86}.  A refined method, called ``reduced form'', treats default as a discrete jump in time.  \Citet{AFV03} was the first to allow stock jumps that didn't go to zero.  The probability of the loss jump over a short period of time is described by a hazard rate.
