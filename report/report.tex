...
Table \ref{tab:choice} illustrated the various choices made by the bond holder and the bond issuer, and under what circumstances those choices are made.  \V is assumed to be the intrinsic value in this context only.  The impact of coupons is left as an implementation detail.
\begin{table}[ht]
 \centering
 \caption{Payoffs for the convertible bond}
