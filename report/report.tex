...
\begin{table}[ht]
 ...
 \begin{tabular}{|l|l|l|}\hline
  ...
  Conversion          & $\Kv\S$         & $(\Kv\S \ge \V)\wedge(\t \in \Tv)$ \\\hline
  Forced conversion   & $\Kv\S$         & $(\V > \Kv\S \ge \Kc)\wedge(\t \in \Tv)\wedge(\t \in \Tc)$ \\\hline
...
\begin{table}[ht]
 ...
 \begin{tabular}{|c|l|c|} \hline
  ...
  \multirow{2}{*}{Call}       & Strike\footnote{The strike of 110 is the clean price and needs to be adjusted for accrued interest, on a simple interest basis} & $\Kc = 110 + \C\tfrac{t \pmod {0.5}}{0.5}$ \\
                              & Period(s)           & $\t \in [2, 5)$ \h
  \multirow{2}{*}{Conversion} & Quantity            & $\Kv = 1$ \\
                              & Period(s)           & $\t \in [0, 5]$ \h
 \end{tabular}
