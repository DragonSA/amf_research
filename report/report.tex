...
In the event of default the portfolio holdings $\P^x$ have a long position in the derivative with residual value \X and a short position of \D in the residual stock with value of $(1 - \eta)\S$.  Thus the difference of the portfolio holdings when going into default is:
\begin{align}
 \dP^x &= \P^x - \P \n
