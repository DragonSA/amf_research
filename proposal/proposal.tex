...
A best effort will include compatibility with Matlab and implementing a Monte Carlo simulation to compare pricing models.  \citet{AKW08} describes one such Monte Carlo based model.
